...
async def process_expenses_data(prompt, expenses_data):
    ...
    async with AzureCliCredential() as credential:
        # Initialize the agent client with your Azure AI project endpoint
        ...
        # Create a chat agent
        agent = await agent_client.create_chat_agent(
            name="expenses_agent",
        ...
        try:
            ...
            chat = await agent.create_chat()
            response = await chat.send_message(f"{prompt}: {expenses_data}")
